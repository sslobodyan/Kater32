...
void Compass9250::calc_bias_mag(){
  ...
  mz_bias = (mz_min+mz_max)/2;
      ...
      DBG.print (" Mx ");
      DBG.print (mx, DEC);
      DBG.print(" (");DBG.print(mx_min);DBG.print(",");DBG.print(mx_max);DBG.print(",");DBG.print(mx_bias);DBG.print(")");
      DBG.print (" My ");
      DBG.print (my, DEC);
      DBG.print(" (");DBG.print(my_min);DBG.print(",");DBG.print(my_max);DBG.print(",");DBG.print(my_bias);DBG.print(")");
      DBG.print (" Mz ");
      DBG.print (mz, DEC);
      DBG.print (" (");DBG.print(mz_min);DBG.print(",");DBG.print(mz_max);DBG.print(",");DBG.print(mz_bias);DBG.print(")");
      DBG.println();
#endif
...
void Compass9250::calc_bias_acc(){
  ...
  ay_bias = (ay_min+ay_max)/2;
      ...
      DBG.print (" Ax ");
      DBG.print (ax, DEC);
      DBG.print(" (");DBG.print(ax_min);DBG.print(",");DBG.print(ax_max);DBG.print(",");DBG.print(ax_bias);DBG.print(")");
      DBG.print (" Ay ");
      DBG.print (ay, DEC);
      DBG.print(" (");DBG.print(ay_min);DBG.print(",");DBG.print(ay_max);DBG.print(",");DBG.print(ay_bias);DBG.print(")");
#endif
